...
(function () {
	...
	*/
	...
	const material = new ShaderMaterial({
	  ...
	  fragmentShader: frag,
	  uniforms: {
	    lightDirection: { value: new Vector3(settings.lightDirectionX, settings.lightDirectionY, settings.lightDirectionZ).normalize() },
	    cameraPositionWorld: { value: camera.position },
	    lightColor: { value: new Color$1(settings.lightColor) },
	    ambientColor: { value: new Color$1(settings.ambientColor) },
